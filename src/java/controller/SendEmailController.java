            ...
            if (action != null) {
                if (action.equals("subscribeEmail")) {
                    ...
                    String message = "<!DOCTYPE html>\n"
                            ...
                            + "    <div>We will try our best to update all the news as soon as possiple to you</div>\n"
                            + "    <div>You will never miss any new product on my shop !</div>\n"
