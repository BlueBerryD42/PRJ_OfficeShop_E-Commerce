<%-- 
    ...
    Created on : July 7, 2024, 11:25:10 PM
    Author     : ASUS
--%>
                        ...
                        <table class="table-order-detail">
                            ...
                            <tbody>
                                <c:forEach items="${requestScope.listOrdersDetail}" var="D">
                                    <tr>
                                        <c:forEach items="${requestScope.listItemsOrder}" var="P">
                                            <c:if test="${D.itemId eq P.id}">
                                                <td>
                                                    <img class="product-img" src="${P.imgPath}" alt="">
                                                    <div class="product-brand">
                                                        <div class="product-name">
                                                            <c:url var="itemD" value="ItemDetailController">
                                                                <c:param name="pid" value="${P.id}"></c:param>
                                                            </c:url>
                                                            <a href="${itemD}">${P.name}</a>
                                                        </div>
