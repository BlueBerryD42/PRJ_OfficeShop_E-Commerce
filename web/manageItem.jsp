<%-- 
    Document   : managePlantitem
    Created on : July 8, 2024, 9:09:21 PM
    Author     : ASUS
--%>
                                    ...
                                    <div class="modal fade" id="blockBtnXYZC" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <form action="UpdateItemController" method="POST">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button id="update-profile-btn" type="submit" class="btn btn-danger" name="action" value="createItem">Create</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="UpdateItemController" method="POST">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button id="update-profile-btn" type="submit" class="btn btn-danger" name="action" value="updateItem">Update</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
                                                            </div>
