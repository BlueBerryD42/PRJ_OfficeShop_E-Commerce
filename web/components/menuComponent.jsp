    ...
    <div class="container-menu-desktop">
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-phone me-2"></i>+84 0969970836</a>
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-envelope me-2"></i>2nguyenanhquan1@gmail.com</a>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <img src="./images/logo-shop.png" alt="IMG-LOGO">
            </a>
            ...
            <div class="menu-desktop">
                <ul class="main-menu">
                    ...
                    <li class="${sessionScope.destPage eq "item" ? "active-menu" : ""}">
...
<div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
        <a href="${homeUrl}"><img src="./images/logo-shop.png" alt="IMG-LOGO"></a>
    </div>
