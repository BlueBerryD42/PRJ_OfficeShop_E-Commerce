...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container px-4 px-lg-5">
        <a href="HomeController"><img class="img-fluid" width="100px" src="./images/NomNom.jpg" alt="Logo"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle ${sessionScope.destPage eq "item" ? "active" : ""}" id="navbarDropdown" href="#" role="button"
                ...
                <div class="login-btn dropdown-hover position-relative">
                    ...
                    <div class="dropdown-menu" style="width: 350px;">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <!-- Unlog in -->
                                <form action="LoginController" onsubmit="get" method="POST" class="px-4 py-2">
                                    <div class="mb-3">
