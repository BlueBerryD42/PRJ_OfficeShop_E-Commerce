<%-- 
    Document   : itemdetail
    Created on : July 5, 2024, 9:50:33 AM
    Author     : ASUS
--%>
        ...
        <div id="search-nav" class="d-flex align-items-center">
            <div class="container text-center">
                <span class="body">
                    ...
                    <span class="txt-m-bold txt-orange default-cursor text-warning">Item Detail</span>
                </span>
            </div>
        </div>
        <!-- Toast MSG -->
        ...
        <section>
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center mb-4">
                    <div class="col-md-6 text-md-end"><img class="card-img-top mb-5 mb-md-0" src="${item.imgPath}" alt="..." style="width: 70%"/>
                    </div>
                    <div class="col-md-6">
                        <div class="small mb-1 default-cursor">SKU: ${item.id}</div>
                        <div class="small mb-1 default-cursor">Category: ${sessionScope.listCategories.get(item.categoryId)}</div>
                        <h1 class="display-5 fw-bolder default-cursor">${item.name}</h1>
                        ...
                        <p class="lead default-cursor">Short description: ${item.description}</p>
                        <div class="d-flex">
                            <a onclick="addToCartAsync(${item.id})" class="btn btn-outline-dark flex-shrink-0">
        ...
        <section class="pt-5 bg-light">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <c:forEach items="${requestScope.listRelativeItems}" var="RL">
                        <!-- Product -->
                        <div class="col mb-5">
                            <div class="card h-100">
                                ...
                                <!-- Product image-->
                                <c:url var="linkImg" value="ItemDetailController">
                                    <c:param name="pid" value="${RL.id}"></c:param>
                                </c:url>
                                <a href="${linkImg}" class="img-h-350"><img src="${RL.imgPath}" alt="Item IMG" /></a>
                                <!-- Product details-->
                                <div class="card-body p-2">
                                    <div class="text-center product-info">
                                        ...
                                        <!-- Product name-->
                                        <div class="name">
                                            <c:url var="linkName" value="ItemDetailController">
                                                <c:param name="pid" value="${RL.id}"></c:param>
                                            </c:url>
