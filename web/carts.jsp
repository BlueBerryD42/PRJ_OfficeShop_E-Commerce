<%-- 
    Document   : carts
    Created on : July 5, 2024, 5:06:06 PM
    Author     : ASUS
--%>
                    ...
                    <c:otherwise>
                        ...
                        <table class="table text-center">
                            ...
                            <c:forEach items="${carts}" var="C">
                                <tag:productCart id="${C.value.item.id}" imgpath="${C.value.item.imgPath}" name="${C.value.item.name}" price="${C.value.item.price}" quantity="${C.value.quantity}"/>
                            </c:forEach>
                            </tbody>
                        </table>
                        <div class="row">
