<%-- 
    Document   : search
    Created on : July 4, 2024, 9:22:49 PM
    Author     : ASUS
--%>
            ...
            <div id="result" class="pt-4">
                <div class="container">
                    <div class="main-title text-black">
                        There are <span>${requestScope.totalItems}</span> matching search results
                    </div>
                    <div class="container px-4 px-lg-5 mt-4">
                        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                            <c:forEach items="${requestScope.listItems}" var="L">
                                <!-- Product -->
                                <div class="col mb-5">
                                    <div class="card h-100">
                                        ...
                                        <a href="${linkImg}" class="img-h-350"><img src="${L.imgPath}" alt="Item Img" /></a>
                                        <!-- Product details-->
