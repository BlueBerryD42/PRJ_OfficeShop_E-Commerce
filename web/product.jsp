<%-- 
    Document   : product
    Created on : July 4, 2024, 6:03:27 PM
    Author     : ASUS
--%>
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="list-group">
                        <a type="button" class="list-group-item list-group-item-action ${(empty requestScope.category)? "active" : ""}" href="ViewAllController">All items</a>
                    ...
                    <c:choose>
                        <c:when test="${empty requestScope.NO_PRODUCT}">
                            ...
                            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-lg-3 justify-content-center">
                                <c:forEach items="${requestScope.listItems}" var="LP">
                                    <!-- Product -->
                                    <div class="col mb-5">
                                        <div class="card h-100">
                                            ...
                                            <a href="${linkImg}" class="img-h-350"><img src="${LP.imgPath}" alt="Item IMG" /></a>
                                            <!-- Product details-->
