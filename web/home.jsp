<%-- 
    Document   : Home
    Created on : July 4, 2024, 1:05:46 PM
    Author     : ASUS
--%>
        ...
        <section class="pt-5">
            ...
            <div class="container px-4 px-lg-5 mt-4">
                <div id="home-all-product" class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    <c:forEach items="${requestScope.listItems}" var="LPS">
                        <!-- Product -->
                        <div class="col mb-5 product-all">
                            <div class="card h-100">
                                ...
                                <a href="${linkImg}" class="img-h-350"><img src="${LPS.imgPath}" alt="Item IMG" /></a>
                                <!-- Product details-->
            ...
            <div style="background-color: #f3f3f3;">
                ...
                <div class="container px-4 px-lg-5 mt-3">
                    ...
                    <div id="home-best-seller" class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                        <c:forEach items="${requestScope.listBestSellerItems}" var="LBSP">
                            <!-- Product -->
                            <div class="col mb-5">
                                <div class="card h-100">
                                    <!-- Sale badge-->
                                    ...
                                    <a href="${linkImg}" class="img-h-350"><img src="${LBSP.imgPath}" alt="Item IMG" /></a>
                                    <!-- Product details-->
                                    <div class="card-body p-2">
                                        <div class="text-center product-info">
                                            <div class="category ms-3 mt-3 text-start">
